<template>
  <div>
<!--    上传按钮  -->
    <el-button @click="$refs.dialog.open({id:-1})" icon="fa fa-cloud-upload" type="success" size="small"> 新的视频</el-button>
<!--    重新上传-对话框  -->
    <BaseDialog ref="dialog" title="上传视频文件" width="400px">
      <template v-slot="{data}">
        <!--  3. 引入对话框中的模版  -->
        <BaseUpload :entity="entity" :data="data" @success="confirm"></BaseUpload>
      </template>
    </BaseDialog>
<!--    视频播放-对话框  -->
    <BaseDialog ref="playDialog"  width="60%" title="视频播放" :buttons="false">
      <template v-slot="{data}">
        <BaseVideo :data="data"></BaseVideo>
      </template>
    </BaseDialog>
      ...
      <template #operation="data">
        ...
        <el-tooltip class="item" effect="light" content="播放" placement="top">
          <el-button
            ...
            size="mini" type="success"  circle plain><i class="fa fa-play"></i></el-button>
        </el-tooltip>
