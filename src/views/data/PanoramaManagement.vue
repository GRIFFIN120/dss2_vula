...
<!--    重新上传-对话框  -->
    <BaseDialog ref="dialog" title="上传全景影像" width="400px">
...
<!--    全景查看-对话框  -->
    <BaseDialog ref="playDialog" width="60%" title="全景影像查看" :buttons="false">
      <template v-slot="{data}">
        <!--  3. 引入对话框中的模版  -->
        <BasePanorama :data="data"></BasePanorama>
      </template>
    </BaseDialog>
      ...
      <template #operation="data">
        ...
        <el-tooltip class="item" effect="light" content="预览" placement="top">
          <el-button
            ...
            size="mini" type="success"  circle plain><i class="fa fa-eye"></i></el-button>
        </el-tooltip>
...
import BasePanorama from '../../components/base/BasePanorama'
